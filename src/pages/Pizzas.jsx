      ...
      <div>
        ...
        <div>
          <div className="gap-y-5">
            <div>
              <img src="/2.jpeg" className="rounded-3xl px-2" alt="" />
            ...
            <div className="mt-4">
              <img src="/ppizza2.jpg" className="rounded-3xl px-2" alt="" />
              <div className="flex justify-between py-2">
                <p className="text-slate-800">Salad 2</p>
                <p className="text-slate-400">250g</p>
              </div>
              <div className="flex justify-between">
                <h5 className="text-2xl">
          ...
          <div className="gap-y-5">
            <div>
              <img src="/pizza3.jpg" className="rounded-3xl px-2" alt="" />
              <div className="flex justify-between py-2">
                <p className="text-slate-800">Salad 1</p>
                <p className="text-slate-400">250g</p>
              </div>
